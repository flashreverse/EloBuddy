...
namespace Reverse_Lux
{
    class Program
    {
        ...
        private static void Loading_OnLoadingComplete(EventArgs args)
        {
            ...
            Menu = MainMenu.AddMenu("Reverse Lux", "reverselux");
            Menu.AddGroupLabel("Reverse Lux V0.5");
            ...
            Chat.Print("Reverse Lux loaded :)", System.Drawing.Color.White);
        }
